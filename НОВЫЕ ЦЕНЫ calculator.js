...
const prefix = "+996 ";
const phoneNumber = prefix + inputValue;
...
function calculateSquare() {
    ...
    if (totalSum) {
        $(document.querySelector(".wall-square")).text(totalSum.toFixed(2) + "м2");
    }
    if (roofArea) {
...
const thickness = $(document.getElementById("thickness")).val();
...
$(document.getElementById("thickness")).on("change", () => {
    calculateSquare();
    calculateSum();
})
